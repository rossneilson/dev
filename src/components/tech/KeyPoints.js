      ...
      <BulletPointContainer>
        <BulletPoint data-sal="slide-up">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.1.title" />
            </Heading>
          </Title>
          <Description>
            <FormattedMessage id="tech.1.desc" />
          </Description>
        </BulletPoint>
        ...
        <BulletPoint data-sal="slide-up" data-sal-delay="600">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.2.title" />
            </Heading>
          </Title>
          <Description>
            <FormattedMessage id="tech.2.desc" />
          </Description>
        </BulletPoint>
        <BulletPoint data-sal="slide-up" data-sal-delay="700">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.3.title" />
            </Heading>
          </Title>
          <Description>
            <FormattedMessage id="tech.3.desc" />
          </Description>
        </BulletPoint>
        <BulletPoint data-sal="slide-up" data-sal-delay="800">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.5.title" />
            </Heading>
          </Title>
          <Description>
        ...
        <BulletPoint data-sal="slide-up" data-sal-delay="900">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.4.title" />
            </Heading>
          </Title>
          <Description>
        ...
        <BulletPoint data-sal="slide-up" data-sal-delay="1000">
          <Title>
            ...
            <Heading>
              <FormattedMessage id="tech.6.title" />
            </Heading>
          </Title>
          <Description>
            <FormattedMessage id="tech.6.desc" />
          </Description>
        </BulletPoint>
      </BulletPointContainer>
    </Explanation>
